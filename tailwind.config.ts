    ...
    extend: {
      ...
      colors: {
        ...
        "app-bar": {
          ...
          hover: "hsl(var(--app-bar-hover))",
          active: "hsl(var(--app-bar-active))",
        },
        "left-rail": {
          DEFAULT: "hsl(var(--left-rail))",
          foreground: "hsl(var(--left-rail-foreground))",
          hover: "hsl(var(--left-rail-hover))",
          active: "hsl(var(--left-rail-active))",
        },
        primary: {
