...
import { Plus, Upload, Users, MoreHorizontal, Edit, Trash2, FileSpreadsheet } from 'lucide-react';
    ...
    <>
      <div className="mb-4">
        <div className="flex items-center justify-between mb-3">
          <h3 className="text-sm font-semibold text-left-rail-foreground">Nhóm tự tạo</h3>
          <Button 
            variant="ghost" 
            size="icon" 
