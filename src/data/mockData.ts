...
export const mockTasks: Task[] = [
  ...
  {
    id: 't-6',
    title: 'Gửi email chúc mừng Giáng sinh',
    description: 'Gửi email chúc mừng lễ Giáng sinh cho toàn bộ khách hàng VIP',
    status: 'todo',
    priority: 'medium',
  ...
  },
  {
    ...
    description: 'Cuộc họp tổng kết kết quả kinh doanh năm 2024 với ban lãnh đạo',
    status: 'todo',
    priority: 'high',
  ...
  {
    id: 't-8',
    title: 'Theo dõi hợp đồng mới',
    description: 'Kiểm tra tiến độ ký kết hợp đồng với khách hàng Võ Thị Hoa',
    status: 'in_progress',
    priority: 'high',
    customerId: '5',
  ...
  },
  {
    ...
    description: 'Thu thập và cập nhật thông tin liên hệ mới cho các khách hàng trong nhóm Referral',
    status: 'done',
    priority: 'low',
  ...
  },
  {
    ...
    description: 'Trình bày demo sản phẩm mới cho nhóm khách hàng tiềm năng Q4',
    status: 'todo',
    priority: 'high',
    dueDate: new Date('2024-12-23'),
    type: 'meeting',
  ...
  },
  {
    ...
    description: 'Xác nhận đơn hàng mới với khách hàng Nguyễn Văn An',
    status: 'todo',
    priority: 'medium',
    customerId: '1',
    customerName: 'Nguyễn Văn An',
  ...
  {
    id: 't-12',
    title: 'Gửi hóa đơn tháng 12',
    description: 'Gửi email hóa đơn dịch vụ tháng 12 cho khách hàng doanh nghiệp',
    status: 'in_progress',
    priority: 'medium',
  ...
  {
    id: 't-13',
    title: 'Kiểm tra feedback khách hàng',
    description: 'Tổng hợp và phân tích feedback khách hàng trong tuần',
    status: 'todo',
    priority: 'low',
    dueDate: new Date('2024-12-27'),
    type: 'other',
  ...
  {
    id: 't-14',
    title: 'Họp với đối tác chiến lược',
    description: 'Cuộc họp bàn về kế hoạch hợp tác năm 2025 với Đỗ Quang Hùng',
    status: 'todo',
    priority: 'high',
    customerId: '6',
    customerName: 'Đỗ Quang Hùng',
  ...
  {
    id: 't-15',
    title: 'Chuẩn bị tài liệu năm mới',
    description: 'Chuẩn bị bộ tài liệu marketing và sales cho Q1/2025',
    status: 'todo',
    priority: 'medium',
  ...
  {
    id: 't-16',
    title: 'Email cảm ơn cuối năm',
    description: 'Gửi email cảm ơn và chúc mừng năm mới đến toàn bộ khách hàng',
    status: 'todo',
    priority: 'medium',
